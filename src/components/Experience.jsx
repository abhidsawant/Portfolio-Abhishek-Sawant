...
const jobs = [
  {
    ...
    points: [
      ...
      'Delivered 12+ major user stories involving complex UI logic for clinical trial phase management.',
      'Resolved 70+ high-priority production bug tickets impacting Pfizer and Jazz Pharma submission timelines.',
