...
export default function ProjectCaseStudy({ project, onClose }) {
  ...
  useEffect(() => { setTab('overview') }, [project])
          ...
          {tab === 'overview' && (
            <>
              ...
              <div className="cs-links">
                {project.github && (
                  <a href={project.github} target="_blank" rel="noreferrer" className="btn-outline cs-link">GitHub ↗</a>
                )}
                {project.live && (
                  <a href={project.live} target="_blank" rel="noreferrer" className="btn-primary cs-link">Live Demo ↗</a>
                )}
              </div>
            </>
          )}
